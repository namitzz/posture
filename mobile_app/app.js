...
async function startWorkout({ skipCamera = false } = {}) {
  startBtn.querySelector('span').textContent = skipCamera ? 'Starting workout...' : 'Initializing AI coach...';
...
startBtn.addEventListener('click', () => startWorkout({ skipCamera: true }));
startNoCameraBtn.addEventListener('click', () => startWorkout());
